...
public class PersonShortFamLinkElement extends WebElement
{
     ...
     */
    public PersonShortFamLinkElement(Individual person)
    {
        PersonFactBuilder pfb = new PersonFactBuilder(person);
        htmlString = HtmlWrapper.wrapHyperlink(pfb.buildPersonFamilyLink(person), person.getFormattedName());
    }
